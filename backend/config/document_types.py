DOCUMENT_TYPES = [
    {
        ...
        "fields": [
            ...
            {"name": "engagement_dates", "label": "Engagement Dates (select training days)", "type": "multidate", "required": True},
            {"name": "payment_days", "label": "Payment Due — Days After Completion", "type": "number", "required": True},
